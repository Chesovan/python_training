...
TRAINING_1 = {'css_selector': "div.post-536 > a", 'description': 'Teamaufbau Training (Fortgeschritten)'}
TRAINING_2 = {'css_selector': "div.post-539 > a", 'description': 'Style Party Training - werde zum Experten'}
TRAINING_3 = {'css_selector': "div.post-541 > a", 'description': 'Einführung: Leadership Training'}
...
class AcademyMeine90Page:

    def __init__(self, driver):
        self.page = WebdriverCommands(driver)

    def save_screen(self):
        self.page.save_screenshot('C:/Users/mariuschesovan/Desktop/pat_screenshots/meine90.png')
    ...
    def complete_first_training(self):
        self.page.save_screenshot('C:/Users/mariuschesovan/Desktop/pat_screenshots/meine90_before_training1.png')
        ...
        try:
            ...
            self.click_breadcrumbs_first()
            pass
        self.page.save_screenshot('C:/Users/mariuschesovan/Desktop/pat_screenshots/meine90_after_training1.png')

    def complete_second_training(self):
        self.page.save_screenshot('C:/Users/mariuschesovan/Desktop/pat_screenshots/meine90_before_training2.png')
        ...
        try:
            ...
            self.click_breadcrumbs_first()
            pass
        self.page.save_screenshot('C:/Users/mariuschesovan/Desktop/pat_screenshots/meine90_after_training2.png')

    def complete_third_training(self):
        self.page.save_screenshot('C:/Users/mariuschesovan/Desktop/pat_screenshots/meine90_before_training3.png')
        ...
        try:
            ...
            # self.click_breadcrumbs_first()
            pass
        self.page.save_screenshot('C:/Users/mariuschesovan/Desktop/pat_screenshots/meine90_after_training3.png')
    ...
    def complete_course(self):
        ...
        for x in range(len(trainings)):
            if trainings[x] == 'Teamaufbau Training (Fortgeschritten)':
                try:
                    self.complete_first_training()
                except:
                    print('cazut la if 1')
            elif trainings[x] == 'Style Party Training - werde zum Experten':
                try:
                    self.complete_second_training()
                except:
                    print('cazut la if 2')
            elif trainings[x] == 'Einführung: Leadership Training':
                try:
                    self.complete_third_training()
                except:
                    print('cazut la if 3')
            x += 1
        print("Meine 90 training finished")